...
- [Task 6 — MRI Compensating Controls](6-compensating_controls.md): four proposed safeguards across three categories and a justified first implementation priority.
