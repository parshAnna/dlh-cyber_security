...
Place this directory at `blue_team/1x00_first_watch` in the `dlh-cyber_security` repository. Tasks 0, 1 and 3 are complete at this stage. Task 2 has not yet been supplied; later deliverables will be added when their instructions and artifacts are available.
